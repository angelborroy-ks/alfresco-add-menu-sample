<@markup id="customDocumentlist-js" target="js" action="after">
 <@script type="text/javascript" 
    src="${url.context}/res/sp/modules/custom-button-sharedfiles.js" group="documentlibrary" />
</@>

<@markup id="customToolbar-sharedfiles-buttons" target="uploadButton" action="before">
